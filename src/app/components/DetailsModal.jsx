...
const DetailsModal = ({ item: selectedItem, onClose }) => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full bg-black/50 flex justify-center items-center transition-opacity duration-300 opacity-100 z-100">
      ...
      <div className="bg-white shadow-lg py-4 rounded-md w-240 max-h-full md:max-h-150 overflow-auto">
        ...
        <div className="px-5 pb-4">
          ...
          <div className="flex flex-col md:flex-row border-r border-l p-1 bg-gray-200 ">
            <p className="text text-gray-700 w-full md:w-1/2">
              <strong>Data de Abertura:</strong>{" "}
              {formatDate(selectedItem.dataCriacao)}
            </p>
            <p className="text text-gray-700 w-full md:w-1/2">
          ...
          <div className="flex flex-col md:flex-row border-t border-r border-l p-1 ">
            <p className="text text-gray-700 w-full md:w-1/2">
          ...
          <div className="flex flex-col md:flex-row  border p-1 bg-gray-200">
            <p className="text text-gray-700 w-full md:w-1/2">
              <strong>Valor:</strong> R${" "}
              {formatNumberToDecimal(selectedItem.valor)}
            </p>
            <p className="text text-gray-700 flex items-center gap-1 w-full md:w-1/2">
                ...
                <div className="flex flex-col items-start">
                  ...
                  <div className="flex flex-col gap-2  rounded w-90p">
                    {selectedItem.anexo.map((anexo, index) => (
                      <div
                        key={index}
                        className="flex gap-2 flex-col md:flex-row p-1 items-start md:items-center justify-between "
                      >
                        <span className="text-sm">
              ...
              <div className="flex flex-col items-start  w-full md:w-1/2">
                ...
                <div className="flex  w-90p">
                  {selectedItem.anexoNF ? (
                    ...
                    <span className="p-2">Não enviada</span>
                  )}
                </div>
              </div>
            </div>
