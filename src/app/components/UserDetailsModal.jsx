      ...
      <div className="bg-white shadow-lg py-4 rounded-md w-240 max-h-full md:max-h-150 overflow-auto">
        ...
        <div className="px-5 pb-4">
          ...
          <div className="flex flex-col md:flex-row border p-1">
            <p className="text text-gray-700 md:w-1/2">
          ...
          <div className="flex flex-col md:flex-row border p-1 bg-gray-200">
            ...
            <p className="text text-gray-700 flex items-center gap-1 md:w-1/2">
              ...
              <div className="flex flex-col items-start w-1/2">
                ...
                <div className="flex w-90p">
                  {selectedItem.anexoNF ? (
                    <div className="flex gap-2 p-1 flex-col md:flex-row md:items-center justify-between w-100">
                      <span>
                        {" "}
                        <InsertDriveFileOutlined /> {
